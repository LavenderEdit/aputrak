...
export function WeekCalendar({
    ...
    return (
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-[#F5F0E6] dark:bg-[#0a1628]">
            <div className="min-h-0 flex-1 overflow-auto p-3">
                <div className="min-w-[880px] border-[3px] border-black dark:border-white/10 bg-[#FFFCF4] dark:bg-[#111827] shadow-[6px_6px_0_#000] dark:shadow-[6px_6px_0_rgba(0,0,0,0.5)] lg:min-w-full">
                    <div
                        className="sticky top-0 z-40 grid border-b-[3px] border-black dark:border-white/10 bg-[#FFFCF4] dark:bg-[#111827]"
                        style={{ gridTemplateColumns }}
                    >
                        <div className="border-r-2 border-black dark:border-white/10 bg-[#F5F0E6] dark:bg-[#0a1628] py-2" />
                        ...
                        {week.map((date) => {
                            ...
                            return (
                                <div
                                    ...
                                    className="border-r-2 border-black dark:border-white/10 bg-[#FFFCF4] dark:bg-[#111827] py-2 text-center last:border-r-0"
                                >
                                    <div className="text-[10px] font-black uppercase tracking-[0.14em] text-slate-500 dark:text-white/50">
                                    ...
                                    <div
                                        className={
                                            today
                                                ...
                                                : "mt-1 text-lg font-black text-black dark:text-white"
                                        }
                                    >
                                        {date.getDate()}
                                    </div>
                    ...
                    >
                        <div className="border-r-2 border-black dark:border-white/10 bg-[#F5F0E6] dark:bg-[#0a1628]">
                            {hours.map((hour) => (
                                <div
                                    key={hour}
                                    className="relative border-b border-black/20 text-right text-[10px] font-black uppercase tracking-[0.08em] text-slate-600 dark:text-white/60"
                                    style={{ height: HOUR_HEIGHT }}
                                >
                                    <span className="absolute right-2 top-[-7px] bg-[#F5F0E6] dark:bg-[#0a1628] px-1">
                                        {formatHour(hour)}
                                    </span>
                                </div>
                            ))}
                                ...
                                <div
                                    ...
                                    style={{
                                        backgroundColor: isToday(date)
                                            ? (isDark ? "#3d3520" : "#F9EAC3")
                                            : (isDark ? "#1a1f2e" : "#FFFCF4"),
                                    }}
                                >
                                    {hours.map((hour) => (
                                        <button
                                            ...
                                            className="block w-full border-b border-black/15 transition hover:bg-black/5 dark:border-white/10 dark:hover:bg-white/10"
                                            style={{ height: HOUR_HEIGHT }}
                                            aria-label={
                                                lang === "es"
                                    ...
                                    {dayActivities.map((activity) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className="absolute left-1.5 right-1.5 z-20 overflow-hidden border-2 border-black dark:border-white/10 px-2 py-1 text-left text-xs leading-tight shadow-[3px_3px_0_#000] dark:shadow-[3px_3px_0_rgba(0,0,0,0.5)] transition hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[5px_5px_0_#000] dark:hover:shadow-[5px_5px_0_rgba(0,0,0,0.5)]"
                                                style={{
                                                    top,
                                                    height,
                                    ...
                                    {showNowLine && (
                                        <div
                                            ...
                                            style={{ top: nowTop }}
                                        >
                                            <span className="absolute -left-1 -top-[4px] h-3 w-3 border-2 border-black bg-red-600 dark:border-white/10" />
                                        </div>
                                    )}
                                </div>
                            );
